...
{
    /// <summary>
    /// CP1 枪口配置静态校验（Docs/13 检查点 1）：对 10 把在役 FP 武器视图断言
    ...
    public static class WeaponMuzzleValidator
    {
        ...
        private static readonly (string ctrl, string view, string expectCasing)[] Jobs =
        {
            ("Assault_Rifle_01_Example_Prefab/Assault_Rifle_01_FPSController.prefab", "FP_Rifle_View", null),
            ("Assault_Rifle_02_Example_Prefab/Assault_Rifle_02_FPSController.prefab", "FP_Rifle02_View", null),
            ("Assault_Rifle_03_Example_Prefab/Assault_Rifle_03_FPSController.prefab", "FP_Rifle03_View", null),
            ("SMG_01_Example_Prefab/SMG_01_FPSController.prefab", "FP_SMG01_View", null),
            ("SMG_02_Example_Prefab/SMG_02_FPSController.prefab", "FP_SMG02_View", null),
            ("Shotgun_01_Example_Prefab/Shotgun_01_FPSController.prefab", "FP_Shotgun01_View",
                "Assets/Low Poly FPS Pack/Prefabs/Example_Prefabs/Casing_Prefabs/Shotgun_Shell_Prefab.prefab"),
            ("Sniper_01_Example_Prefab/Sniper_01_FPSController.prefab", "FP_Sniper01_View",
                "Assets/Low Poly FPS Pack/Prefabs/Example_Prefabs/Casing_Prefabs/Big_Casing_Prefab.prefab"),
            ("Sniper_02_Example_Prefab/Sniper_02_FPSController.prefab", "FP_Sniper02_View",
                "Assets/Low Poly FPS Pack/Prefabs/Example_Prefabs/Casing_Prefabs/Big_Casing_Prefab.prefab"),
            ("Handgun_01_Example_Prefab/Handgun_01_FPSController.prefab", "FP_ServicePistol_View", null),
            ("Handgun_02_Example_Prefab/Handgun_02_FPSController.prefab", "FP_Handgun02_View", null),
        };
        ...
        public static void Run()
        {
            ...
            report.AppendLine("==== Weapon Muzzle Validator（在役 10 把）====");

            foreach (var job in Jobs)
            {
                var errors = new List<string>();

                // 原厂膛线基准（Components 旋转，weapon 骨局部）
                ...
                try
                {
                    ...
                    if (wb == null || comps == null) { errors.Add("原厂节点缺失"); boreLocal = Quaternion.identity; }
                    else boreLocal = Quaternion.Inverse(wb.rotation) * comps.rotation;
                }
                ...
                if (errors.Count == 0) { pass++; report.AppendLine("[PASS] " + job.view); }
                else { fail++; report.AppendLine("[FAIL] " + job.view + " → " + string.Join("; ", errors)); }
            }
