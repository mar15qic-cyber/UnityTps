...
namespace Game.Presentation.HUD
{
    ...
    public sealed class CrosshairPresenter : MonoBehaviour
    {
        ...
        {
            if (shot.Result.Damaged) Model.HitMarkerRemaining = config.HitMarkerSeconds;
        }
        ...
        private void Update()
        {
            ...
            Model.CurrentGap = Mathf.MoveTowards(Model.CurrentGap, targetGap, config.SmoothSpeed * Time.deltaTime);
